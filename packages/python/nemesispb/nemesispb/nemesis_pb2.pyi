...
class Alert(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["originating_service", b"originating_service", "text", b"text", "type", b"type"]) -> None: ...
...
class Metadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_operation", b"_operation", "_source", b"_source", "expiration", b"expiration", "operation", b"operation", "source", b"source", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_operation", b"_operation", "_source", b"_source", "agent_id", b"agent_id", "agent_type", b"agent_type", "automated", b"automated", "data_type", b"data_type", "expiration", b"expiration", "message_id", b"message_id", "operation", b"operation", "project", b"project", "source", b"source", "timestamp", b"timestamp"]) -> None: ...
    @typing.overload
...
class AuthenticationDataIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "is_file", b"is_file", "notes", b"notes", "originating_object_id", b"originating_object_id", "type", b"type", "uri", b"uri", "username", b"username"]) -> None: ...
...
class FileDataIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["object_id", b"object_id", "originating_object_id", b"originating_object_id", "path", b"path", "size", b"size"]) -> None: ...
...
class FileInformationIngestion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["access_time", b"access_time", "creation_time", b"creation_time", "modification_time", b"modification_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["access_mode", b"access_mode", "access_time", b"access_time", "creation_time", b"creation_time", "group", b"group", "id", b"id", "modification_time", b"modification_time", "owner", b"owner", "path", b"path", "sddl", b"sddl", "size", b"size", "type", b"type", "version_info", b"version_info"]) -> None: ...
...
class Principal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_name", b"_name", "_sid", b"_sid", "name", b"name", "sid", b"sid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_name", b"_name", "_sid", b"_sid", "name", b"name", "sid", b"sid"]) -> None: ...
    @typing.overload
...
class Token(google.protobuf.message.Message):
    ...
    class TokenPrivilege(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["enabled", b"enabled", "privilege_name", b"privilege_name"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["_impersonation_level", b"_impersonation_level", "_session", b"_session", "_type", b"_type", "_user", b"_user", "impersonation_level", b"impersonation_level", "session", b"session", "type", b"type", "user", b"user"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_impersonation_level", b"_impersonation_level", "_session", b"_session", "_type", b"_type", "_user", b"_user", "groups", b"groups", "impersonation_level", b"impersonation_level", "privileges", b"privileges", "session", b"session", "type", b"type", "user", b"user"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_impersonation_level", b"_impersonation_level"]) -> typing.Literal["impersonation_level"] | None: ...
    @typing.overload
...
class ProcessIngestion(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_file_name", b"_file_name"]) -> typing.Literal["file_name"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_memory", b"_memory"]) -> typing.Literal["memory"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_name", b"_name"]) -> typing.Literal["name"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_parent_process_id", b"_parent_process_id"]) -> typing.Literal["parent_process_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_process_id", b"_process_id"]) -> typing.Literal["process_id"] | None: ...
    @typing.overload
...
class RawDataIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "is_file", b"is_file", "tags", b"tags"]) -> None: ...
...
class RegistryValueIngestion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_sddl", b"_sddl", "_tags", b"_tags", "_value", b"_value", "_value_kind", b"_value_kind", "_value_name", b"_value_name", "sddl", b"sddl", "tags", b"tags", "value", b"value", "value_kind", b"value_kind", "value_name", b"value_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_sddl", b"_sddl", "_tags", b"_tags", "_value", b"_value", "_value_kind", b"_value_kind", "_value_name", b"_value_name", "key", b"key", "sddl", b"sddl", "tags", b"tags", "value", b"value", "value_kind", b"value_kind", "value_name", b"value_name"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_sddl", b"_sddl"]) -> typing.Literal["sddl"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_tags", b"_tags"]) -> typing.Literal["tags"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_value", b"_value"]) -> typing.Literal["value"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_value_kind", b"_value_kind"]) -> typing.Literal["value_kind"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_value_name", b"_value_name"]) -> typing.Literal["value_name"] | None: ...
...
class ServiceIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "display_name", b"display_name", "name", b"name", "service_command", b"service_command", "service_dll", b"service_dll", "service_sddl", b"service_sddl", "start_mode", b"start_mode", "start_name", b"start_name", "state", b"state", "type", b"type"]) -> None: ...
...
class HostInformationIngestion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_long_name", b"_long_name", "_short_name", b"_short_name", "long_name", b"long_name", "short_name", b"short_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_long_name", b"_long_name", "_short_name", b"_short_name", "ip_addresses", b"ip_addresses", "long_name", b"long_name", "short_name", b"short_name"]) -> None: ...
    @typing.overload
...
class NetworkConnectionIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["local_address", b"local_address", "process_id", b"process_id", "process_name", b"process_name", "protocol", b"protocol", "remote_address", b"remote_address", "service", b"service", "state", b"state"]) -> None: ...
...
class SlackWorkspaces(google.protobuf.message.Message):
    ...
    class SlackWorkspace(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["username", b"username", "workspace_domain", b"workspace_domain", "workspace_icon_url", b"workspace_icon_url", "workspace_id", b"workspace_id", "workspace_name", b"workspace_name"]) -> None: ...
...
class SlackDownloads(google.protobuf.message.Message):
    ...
    class SlackDownload(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["download_id", b"download_id", "download_path", b"download_path", "download_state", b"download_state", "end_time", b"end_time", "start_time", b"start_time", "team_id", b"team_id", "url", b"url", "user_id", b"user_id", "username", b"username", "workspace_id", b"workspace_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["downloads", b"downloads"]) -> None: ...
...
class Lnk(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["accessed_time", b"accessed_time", "creation_time", b"creation_time", "modified_time", b"modified_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["accessed_time", b"accessed_time", "command_line_arguments", b"command_line_arguments", "comment", b"comment", "creation_time", b"creation_time", "location", b"location", "machine_identifier", b"machine_identifier", "modified_time", b"modified_time", "run_as_admin", b"run_as_admin", "target", b"target", "target_file_size", b"target_file_size", "working_directory", b"working_directory"]) -> None: ...
...
class Passwd(google.protobuf.message.Message):
    ...
    class PasswdEntry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["group_id", b"group_id", "home_directory", b"home_directory", "shell", b"shell", "user_id", b"user_id", "username", b"username"]) -> None: ...
...
class Shadow(google.protobuf.message.Message):
    ...
    class ShadowEntry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["password_last_changed", b"password_last_changed"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["password", b"password", "password_last_changed", b"password_last_changed", "username", b"username"]) -> None: ...
...
class OfficeDocOle(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_encryption_hash", b"_encryption_hash", "created", b"created", "encryption_hash", b"encryption_hash", "modified", b"modified"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_encryption_hash", b"_encryption_hash", "comments", b"comments", "created", b"created", "creating_application", b"creating_application", "creator", b"creator", "encryption_hash", b"encryption_hash", "is_encrypted", b"is_encrypted", "keywords", b"keywords", "last_modified_by", b"last_modified_by", "modified", b"modified", "num_chars", b"num_chars", "num_pages", b"num_pages", "num_slides", b"num_slides", "subject", b"subject", "title", b"title", "total_edit_time", b"total_edit_time"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_encryption_hash", b"_encryption_hash"]) -> typing.Literal["encryption_hash"] | None: ...
...
class GroupPolicyPreferences(google.protobuf.message.Message):
    ...
    class GroupPolicyPreferencesEntry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["changed", b"changed"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["action", b"action", "changed", b"changed", "cpassword", b"cpassword", "description", b"description", "disabled", b"disabled", "never_expires", b"never_expires", "newname", b"newname", "password", b"password", "username", b"username"]) -> None: ...
...
class McafeeSitelist(google.protobuf.message.Message):
    ...
    class McafeeSitelistEntry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["domain_name", b"domain_name", "enabled", b"enabled", "local", b"local", "name", b"name", "password", b"password", "password_encrypted", b"password_encrypted", "relativepath", b"relativepath", "server", b"server", "share_name", b"share_name", "type", b"type", "useauth", b"useauth", "used_loggedon_user_account", b"used_loggedon_user_account", "username", b"username"]) -> None: ...
...
class Tomcat(google.protobuf.message.Message):
    ...
    class TomcatEntry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["password", b"password", "roles", b"roles", "username", b"username"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["entries", b"entries", "roles", b"roles"]) -> None: ...
...
class JWTToken(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audience", b"audience", "issuer", b"issuer", "key", b"key", "minutes_to_expiration", b"minutes_to_expiration"]) -> None: ...
...
class DatabaseCredential(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["database", b"database", "password", b"password", "server", b"server", "type", b"type", "username", b"username"]) -> None: ...
...
class ConnectionString(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["database_credential", b"database_credential"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["connection_string", b"connection_string", "database_credential", b"database_credential", "name", b"name", "provider_name", b"provider_name"]) -> None: ...
...
class WebConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["connection_strings", b"connection_strings"]) -> None: ...
...
class AppSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["connection_strings", b"connection_strings", "jwt_tokens", b"jwt_tokens"]) -> None: ...
...
class Signature(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["signers", b"signers", "verification_flags", b"verification_flags", "version", b"version"]) -> None: ...
...
class Symbol(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["func_name", b"func_name", "offset", b"offset", "ordinal", b"ordinal"]) -> None: ...
...
class Dll(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "symbols", b"symbols"]) -> None: ...
...
class Imports(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dlls", b"dlls"]) -> None: ...
...
class Pe(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["exports", b"exports", "header", b"header", "imports", b"imports", "version_info", b"version_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["exports", b"exports", "header", b"header", "imports", b"imports", "signatures", b"signatures", "string_resources", b"string_resources", "version_info", b"version_info"]) -> None: ...
...
class Resource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["md5", b"md5", "name", b"name", "sha1", b"sha1", "sha256", b"sha256"]) -> None: ...
...
class Typeref(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["function_name", b"function_name", "module_name", b"module_name"]) -> None: ...
...
class Archive(google.protobuf.message.Message):
    ...
    class ArchiveEntry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["last_modified", b"last_modified"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["compress_size", b"compress_size", "is_dir", b"is_dir", "last_modified", b"last_modified", "name", b"name", "uncompress_size", b"uncompress_size"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["_encryption_hash", b"_encryption_hash", "encryption_hash", b"encryption_hash"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_encryption_hash", b"_encryption_hash", "encryption_hash", b"encryption_hash", "entries", b"entries", "is_encrypted", b"is_encrypted", "type", b"type", "uncompressed_size", b"uncompressed_size"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_encryption_hash", b"_encryption_hash"]) -> typing.Literal["encryption_hash"] | None: ...
...
class RegHiveSystem(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["boot_key", b"boot_key"]) -> None: ...
...
class DomainCachedCredential(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["answer", b"answer", "cached_hash", b"cached_hash", "domain_long", b"domain_long", "enc_raw_value", b"enc_raw_value", "is_decrypted", b"is_decrypted", "iteration_count", b"iteration_count", "timestamp", b"timestamp", "user_name", b"user_name"]) -> None: ...
...
class LSASecret(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["is_decrypted", b"is_decrypted", "name", b"name", "value_dec", b"value_dec", "value_dec_str", b"value_dec_str", "value_enc", b"value_enc"]) -> None: ...
...
class SamHash(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["answer", b"answer", "is_decrypted", b"is_decrypted", "lm_hash_dec", b"lm_hash_dec", "lm_hash_enc", b"lm_hash_enc", "new_style", b"new_style", "nt_hash_dec", b"nt_hash_dec", "nt_hash_enc", b"nt_hash_enc", "rid", b"rid", "username", b"username"]) -> None: ...
...
class RegHiveSam(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["f_bytes", b"f_bytes", "hashed_boot_key", b"hashed_boot_key", "is_decrypted", b"is_decrypted", "sam_hashes", b"sam_hashes"]) -> None: ...
...
class DpapiCredentialAttribute(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "flags", b"flags", "keyword", b"keyword"]) -> None: ...
...
class DpapiCredentialFile(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["last_written", b"last_written"]) -> builtins.bool: ...
...
class ChromiumHistoryFile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "downloads_count", b"downloads_count", "urls_count", b"urls_count", "user_data_directory", b"user_data_directory", "username", b"username"]) -> None: ...
...
class ChromiumLoginsFile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "logins_count", b"logins_count", "user_data_directory", b"user_data_directory", "username", b"username"]) -> None: ...
...
class ChromiumCookiesFile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "cookies_count", b"cookies_count", "user_data_directory", b"user_data_directory", "username", b"username"]) -> None: ...
...
class EvtxFile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["converted_csv", b"converted_csv", "converted_json", b"converted_json", "originating_object_id", b"originating_object_id"]) -> None: ...
...
class DotnetAnalysis(google.protobuf.message.Message):
    ...
    class GadgetCall(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["filter_level", b"filter_level", "gadget_name", b"gadget_name", "method_name", b"method_name"]) -> None: ...
...
class Analysis(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["analysis_type", b"analysis_type", "dotnet_analysis", b"dotnet_analysis"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["analysis_type", b"analysis_type", "dotnet_analysis", b"dotnet_analysis"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["analysis_type", b"analysis_type"]) -> typing.Literal["dotnet_analysis"] | None: ...
...
class ChromiumHistoryEntry(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["last_visit_time", b"last_visit_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "last_visit_time", b"last_visit_time", "originating_object_id", b"originating_object_id", "title", b"title", "typed_count", b"typed_count", "url", b"url", "user_data_directory", b"user_data_directory", "username", b"username", "visit_count", b"visit_count"]) -> None: ...
...
class ChromiumDownload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["end_time", b"end_time", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "danger_type", b"danger_type", "download_path", b"download_path", "end_time", b"end_time", "originating_object_id", b"originating_object_id", "start_time", b"start_time", "total_bytes", b"total_bytes", "url", b"url", "user_data_directory", b"user_data_directory", "username", b"username"]) -> None: ...
...
class DpapiDomainBackupkey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["domain_backupkey_bytes", b"domain_backupkey_bytes", "domain_backupkey_guid", b"domain_backupkey_guid", "domain_controller", b"domain_controller"]) -> None: ...
...
class ServiceEnriched(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["category", b"category", "enrichments_failure", b"enrichments_failure", "enrichments_success", b"enrichments_success", "origin", b"origin"]) -> None: ...
...
class ProcessCategory(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["category", b"category", "description", b"description"]) -> None: ...
...
class ProcessEnriched(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["category", b"category", "origin", b"origin"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["category", b"category", "enrichments_failure", b"enrichments_failure", "enrichments_success", b"enrichments_success", "origin", b"origin"]) -> None: ...
...
class NoseyParker(google.protobuf.message.Message):
    ...
    class Start(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["column", b"column", "line", b"line"]) -> None: ...
    ...
    class Location(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["offset_span", b"offset_span", "source_span", b"source_span"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["offset_span", b"offset_span", "source_span", b"source_span"]) -> None: ...
    ...
    class Snippet(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["after", b"after", "before", b"before", "matching", b"matching"]) -> None: ...
    ...
    class BlobMetadata(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["charset", b"charset", "id", b"id", "mime_essence", b"mime_essence", "num_bytes", b"num_bytes"]) -> None: ...
    ...
    class Matches(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["blob_metadata", b"blob_metadata", "location", b"location", "snippet", b"snippet"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["blob_id", b"blob_id", "blob_metadata", b"blob_metadata", "capture_group_index", b"capture_group_index", "location", b"location", "match_content", b"match_content", "provenance", b"provenance", "rule_name", b"rule_name", "snippet", b"snippet"]) -> None: ...
    ...
    class RuleMatches(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["comment", b"comment", "match_content", b"match_content", "matches", b"matches", "num_matches", b"num_matches", "rule_name", b"rule_name", "status", b"status", "type", b"type"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["has_matches", b"has_matches", "rule_matches", b"rule_matches"]) -> None: ...
...
class YaraMatches(google.protobuf.message.Message):
    ...
    class YaraStringMatchInstance(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["length", b"length", "matched_data", b"matched_data", "offset", b"offset"]) -> None: ...
    ...
    class YaraStringMatch(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["identifier", b"identifier", "yara_string_match_instances", b"yara_string_match_instances"]) -> None: ...
    ...
    class YaraMatch(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["rule_description", b"rule_description", "rule_file", b"rule_file", "rule_name", b"rule_name", "rule_string_matches", b"rule_string_matches", "rule_text", b"rule_text"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["yara_matches", b"yara_matches", "yara_matches_present", b"yara_matches_present"]) -> None: ...
...
class Canaries(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["canaries", b"canaries", "canaries_present", b"canaries_present"]) -> None: ...
...
class FileHashes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["md5", b"md5", "sha1", b"sha1", "sha256", b"sha256"]) -> None: ...
...
class ExtractedHash(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cracker_cracked_time", b"cracker_cracked_time", "cracker_submission_time", b"cracker_submission_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["checked_against_top_passwords", b"checked_against_top_passwords", "cracker_cracked_time", b"cracker_cracked_time", "cracker_submission_time", b"cracker_submission_time", "hash_type", b"hash_type", "hash_value", b"hash_value", "hashcat_formatted_value", b"hashcat_formatted_value", "is_cracked", b"is_cracked", "is_submitted_to_cracker", b"is_submitted_to_cracker", "jtr_formatted_value", b"jtr_formatted_value", "jtr_pot_line", b"jtr_pot_line", "originating_object_id", b"originating_object_id", "plaintext_value", b"plaintext_value"]) -> None: ...
...
class FileDataPlaintext(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["noseyparker", b"noseyparker"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["enrichments_failure", b"enrichments_failure", "enrichments_success", b"enrichments_success", "noseyparker", b"noseyparker", "object_id", b"object_id", "originating_object_converted_pdf", b"originating_object_converted_pdf", "originating_object_id", b"originating_object_id", "originating_object_path", b"originating_object_path", "originating_object_size", b"originating_object_size", "size", b"size", "summary", b"summary", "word_count", b"word_count"]) -> None: ...
...
class FileDataPlaintextChunkMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["chunk_size", b"chunk_size", "originating_object_id", b"originating_object_id", "originating_object_path", b"originating_object_path", "plaintext_object_id", b"plaintext_object_id", "text", b"text"]) -> None: ...
...
class FileDataSourcecode(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["extension", b"extension", "language", b"language", "name", b"name", "object_id", b"object_id", "originating_object_id", b"originating_object_id", "path", b"path", "size", b"size"]) -> None: ...
...
class Process(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["start_time", b"start_time", "token", b"token"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["arch", b"arch", "command_line", b"command_line", "file_name", b"file_name", "memory", b"memory", "name", b"name", "parent_process_id", b"parent_process_id", "process_id", b"process_id", "start_time", b"start_time", "token", b"token"]) -> None: ...
...
class NetworkAddressIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["address", b"address", "nic", b"nic", "type", b"type"]) -> None: ...
...
class RouteDataIngestion(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["destination", b"destination", "gateway", b"gateway", "mask", b"mask", "nic", b"nic", "protocol", b"protocol"]) -> None: ...
...
class UserTime(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["session", b"session", "time", b"time", "user", b"user"]) -> None: ...
...
class TimeDataIngestion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["current", b"current"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["current", b"current", "runtime", b"runtime", "users", b"users", "zone", b"zone"]) -> None: ...
