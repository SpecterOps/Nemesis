...
from nemesis_dpapi import DomainBackupKey, DpapiManager, DpapiSystemCredential, MasterKey
...
async def dpapi_background_monitor() -> None:
    ...
    await dpapi_manager.upsert_masterkey(
        MasterKey(
            guid=UUID("ed93694f-5a6d-46e2-b821-219f2c0ecd4d"),
    ...
    await dpapi_manager.upsert_masterkey(
        MasterKey(
            guid=UUID("dd26f81a-4ed9-49fd-8b45-42723d8ae006"),
