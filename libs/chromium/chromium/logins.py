...
def process_chromium_logins(object_id: str, file_path: str | None = None) -> None:
    ...
    with psycopg.connect(conn_str) as pg_conn:
        _insert_logins(file_enriched, username, browser, db_path, pg_conn)

    logger.debug("Completed processing Chromium Login Data", object_id=object_id)


def _insert_logins(file_enriched, username: str | None, browser: str, db_path: str, pg_conn) -> None:
