...
def format_exif_display(exif_data):
    ...
    # Image Settings
    image_settings = {}
    for key in ['ExposureTime', 'FNumber', 'ISO', 'ISOSpeedRatings', 'FocalLength',
                'Flash', 'WhiteBalance', 'ExposureProgram', 'MeteringMode', 'ExposureBiasValue']:
        if key in exif_data:
    ...
    # Date and Time
    datetime_info = {}
    for key in ['DateTime', 'DateTimeOriginal', 'DateTimeDigitized', 'OffsetTime',
    ...
    # Image Dimensions
    image_dims = {}
    for key in ['ImageWidth', 'ImageLength', 'ExifImageWidth', 'ExifImageHeight',
