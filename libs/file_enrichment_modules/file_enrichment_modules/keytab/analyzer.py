...
rule Keytab_File
{
    ...
    def should_process(self, object_id: str) -> bool:
        ...
        logger.debug(f"KeytabAnalyzer should_run: {should_run}")
        return should_run
                                    ...
                                    if possible_key_type in self.key_types and 8 <= possible_key_len <= 64:
                                        if i + 4 + possible_key_len <= len(entry_data):
                                            ...
                                            entry_info = {
                                                ...
                                                "key_type_name": self.key_types.get(possible_key_type, f"Unknown ({possible_key_type})"),
